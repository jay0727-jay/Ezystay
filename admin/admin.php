...
.admin-button, .logout-button {
    ...
    height: 30px;
    width: 100px;
    background-color: rgba(116, 182, 124, 0.7); /* Admin button background color */
    border: none;
    border-radius: 20px;
    color: white;
...
<body>
    ...
    <a href="../admin/addadmin.php" class="admin-button">Add Admin</a>
    ...
    <nav class="sidenav">
        <ul>
            ...
            <li class="pagebtn"><img src="../image/icon/feedback.png">&nbsp&nbsp&nbsp Feedback</li>
        </ul>
    </nav>
